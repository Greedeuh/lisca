...
pub fn parse_shortcut(input: &str) -> Result<ShortcutConfig, ParseError> {
...
pub fn save_hotkey(path: &Path, config: &ShortcutConfig) -> Result<(), String> {
...
pub fn load_hotkey(path: &Path) -> Option<ShortcutConfig> {
